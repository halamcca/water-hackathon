...
def plot_hydrographic_maps(
    ...
    demonym = "French" if area=="france" else ("Brazilian" if area=="brazil" else "Unknown")
    fig.suptitle(f"{demonym} Hydrographic Division - 4 Levels", fontsize=16)
    BBOX_DISPLAY = [bbox[area][0],
                    bbox[area][2],
                    bbox[area][1],
                    bbox[area][3]]
